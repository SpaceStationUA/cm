...
Зауважу знов що ціль цього проекту - переклад, так що, якщо ви хочете допомогти саме в розробці гри — перейдить на [освноний репозіторій](https://github.com/CM-14/CM-14).
