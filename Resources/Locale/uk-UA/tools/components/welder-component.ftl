...
welder-component-no-fuel-message = У зварювальнику не залишилося пального!
...
welder-component-on-examine-detailed-message = Пальне: [color={$colorName}]{$fuelLeft}/{$fuelCapacity}[/color].
welder-component-suicide-lit-others-message = {$victim} заварюває всі свої отвори! Виглядає так, ніби вони намагаються покічнити з життям!
