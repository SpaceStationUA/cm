...
job-greet-crew-shortages = Із-за проблем з мобілізацією вам був видан додатковий доступ.
job-not-available-wait-in-lobby = Раунд вже розпочався, але ви не получили жодну з ваших обраних ролей (або не обрали їх) та вибрали залишитися в лобі. Ви можете змінити це у меню кастомізації.
